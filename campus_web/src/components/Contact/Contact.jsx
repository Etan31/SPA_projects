...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", import.meta.env.VITE_EMAIL_API_FROM_WEB3FORMS);
        ...
        <div className='contact'>
            ...
            <div className="contact-col">
                <form onSubmit={onSubmit}>
                    ...
                    <button type='submit' className='btn dark-btn'>Submit now <img src={white_arrow} alt="submit" /></button>
                </form>
                <span>{result}</span>
            </div>
        </div>
